...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-134%20bestanden-brightgreen" alt="Tests">
...
- **134 automatisierte Tests** (Unit + Integration + Multi-User API + Achievements)
...
```bash
npm test              # Alle 134 Tests ausführen (vitest)
