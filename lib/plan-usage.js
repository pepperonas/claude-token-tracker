...
module.exports = {
  initPlanUsage,
  // Test hook: the shape normaliser is the one piece of real logic here and
  // must handle both snake_case and camelCase, which no live call proves.
  _normalizeUsageResponse,
  getOAuthToken,
  saveOAuthToken,
  deleteOAuthToken,
  hasOAuthToken,
