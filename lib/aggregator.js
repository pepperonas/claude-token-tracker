...
class Aggregator {
  ...
  _applyDelta(msg, sign) {
    ...
    const dPricing = getPricing(msg.model, msg.timestamp);
    ...
    const hPricing = getPricing(msg.model, msg.timestamp);
  ...
  getOverview(from, to) {
    ...
    for (const msg of this.messages) {
      ...
      const pricing = getPricing(msg.model, msg.timestamp);
