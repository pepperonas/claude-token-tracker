  ...
  for (const line of lines) {
    ...
    if (obj.type === 'assistant' && obj.message) {
      ...
      msgMap.set(msgId, {
        ...
        // Cache writes come in two TTL tiers priced differently (5m = 1.25x
        // input, 1h = 2x). `cache_creation` is absent on older entries — then
        // both stay 0, which lib/pricing.js reads as "split unknown".
