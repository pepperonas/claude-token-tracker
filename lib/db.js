...
/** Flattened map across all users — used by the global (admin) share aggregator. */
function getAllProjectAliasMap() {
  return _flattenAliases(db.prepare('SELECT alias, canonical FROM project_aliases').all());
}
