/**
 * Achievements system — 500 achievements unlockable through Claude Code usage.
...
const ACHIEVEMENTS = [
  ...
  { key: 'output_ratio_70', category: 'tokens', tier: 'platinum', emoji: '📊', check: s => s.outputRatio >= 0.7 },
  { key: 'output_ratio_80', category: 'tokens', tier: 'diamond', emoji: '📈', check: s => s.outputRatio >= 0.8 },
  ...
  { key: 'model_haiku_majority', category: 'models', tier: 'platinum', emoji: '🍂', check: s => s.totalMessages > 0 && s.modelMessages.haiku > s.totalMessages * 0.5 },
  ...
  { key: 'streak_1500', category: 'streaks', tier: 'diamond', emoji: '⭐', check: s => s.longestStreak >= 1_500 },
  { key: 'streak_2000', category: 'streaks', tier: 'diamond', emoji: '🏆', check: s => s.longestStreak >= 2_000 },
  ...
  { key: 'active_days_3650', category: 'streaks', tier: 'diamond', emoji: '🎯', check: s => s.activeDays >= 3_650 },
  { key: 'months_active_48', category: 'streaks', tier: 'diamond', emoji: '📅', check: s => s.monthsActive >= 48 },
  { key: 'months_active_60', category: 'streaks', tier: 'diamond', emoji: '🏛️', check: s => s.monthsActive >= 60 },
...
/**
 * Get all 500 achievements with unlock status for API response.
 */
