...
// One implementation for every credential held at rest; see lib/secret-box.js.
// The names stay for the call sites and tests that already use them.
const encryptKey = secretBox.encrypt;
const decryptKey = secretBox.decrypt;
