const LANG = {
  ...
  de: {
    ...
    infoInputTitle: 'Input Tokens',
    infoInputDesc: 'Tokens, die an das Modell gesendet werden — deine Frage, Code-Kontext, Systemanweisungen und Gespraechsverlauf. Diese Tokens liest Claude, um deine Anfrage zu verstehen.',
    infoOutputTitle: 'Output Tokens',
    infoOutputDesc: 'Tokens, die Claude in seiner Antwort generiert — Code, Erklaerungen, Tool-Aufrufe. Diese sind pro Einheit in der Regel die teuersten Tokens.',
    infoCacheReadTitle: 'Cache Read Tokens',
    infoCacheReadDesc: 'Input-Tokens, die aus Anthropics Prompt-Cache gelesen werden, anstatt neu verarbeitet zu werden. Wenn Teile deines Prompts (wie Systemanweisungen oder langer Kontext) sich ueber Anfragen wiederholen, koennen sie gecacht werden. Cache-Reads sind deutlich guenstiger als regulaere Input-Tokens (~90% guenstiger).',
    infoCacheCreateTitle: 'Cache Create Tokens',
    infoCacheCreateDesc: 'Tokens, die erstmalig in den Prompt-Cache geschrieben werden. Dies ist ein einmaliger Aufwand pro eindeutigem Prompt-Praefix. Folgende Anfragen mit gleichem Praefix profitieren dann vom Cache-Read-Preis. Cache-Create-Kosten sind aehnlich wie regulaere Input-Kosten.',
    infoCostTitle: 'Kostenschaetzung',
    infoCostDesc: 'Die angezeigten Kosten sind API-aequivalente Schaetzungen basierend auf offiziellen Anthropic-Preisen pro Modell. Claude Code (Max-Plan) wird als Flatrate-Abonnement abgerechnet, nicht pro Token. Diese Schaetzungen zeigen, was deine Nutzung zu API-Preisen kosten wuerde — nuetzlich zum Verstaendnis relativer Nutzungsmuster.',
    infoDataSourceTitle: 'Datenquelle',
    infoDataSourceDesc: 'Alle Daten werden aus den lokalen JSONL-Sitzungsdateien von Claude Code unter ~/.claude/projects/ gelesen. Es werden keine Daten an externe Dienste gesendet. Der Tracker liest diese Dateien, extrahiert Token-Zaehler pro Nachricht und speichert sie in einer lokalen SQLite-Datenbank.',
    infoToggleTitle: 'Cache-Umschalter',
    infoToggleDesc: 'Standardmaessig werden gecachte Tokens in den Statistiken ausgeblendet, da sie Infrastruktur-Overhead darstellen und nicht tatsaechlich verarbeiteten Inhalt. Nutze den "Cache"-Schalter im Header, um sie einzubeziehen. Mit Cache siehst du das vollstaendige Bild; ohne Cache nur die Tokens, die direkt zu deinen Interaktionen beitragen.',
